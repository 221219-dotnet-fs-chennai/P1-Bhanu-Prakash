...
namespace Console
{
    public class AddEducation : IMenu
    {
        ...
        public void Display()
        {
            ...
            System.Console.WriteLine("[2] Id - " + neweducation.Userid);
            System.Console.WriteLine("[3] HigherEducation - " + neweducation.HigherEducation);
            System.Console.WriteLine("[4] University - " + neweducation.university);
            System.Console.WriteLine("[5] StartYear - " + neweducation.Startyear);
            System.Console.WriteLine("[6] EndYear- " + neweducation.Endyear);
            System.Console.WriteLine("[7] Grade - " + neweducation.Grade);
        }
        ...
        public string UserChoice()
        {
            ...
            switch (userInput)
            {
                ...
                case "2":
                    ...
                    neweducation.Userid = Convert.ToInt32(System.Console.ReadLine());
                    return "AddEducation";
                case "3":
